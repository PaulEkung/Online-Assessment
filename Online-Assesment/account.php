...
<div class="row">
<div class="col-lg-6">
<span class="logo">Online</span></div>
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Reg. Number</b></td><td><b>Course Title</b></td><td><b>Course Code</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
while($row=mysqli_fetch_assoc($q12) )
{
$name=$row['name'];
$gender=$row['gender'];
$college=$row['college'];
$code=$row['mob'];
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$code.'</td><td>'.$s.'</td><td>';
}
}
echo '</table></div></div>';}
?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="font-family:'typo' ">Department of computer science, Akanu Ibiam Federal Polytechnic Unwana</h4></div></div>
		</p>
      </div>
