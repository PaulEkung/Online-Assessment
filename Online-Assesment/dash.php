...
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This exams is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td>
<td><b>Reg.Number</b></td><td><b>Course Title</b></td><td><b>Course Code</b></td><td><b>Score</b></td></tr>';
$c=0;
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Exams Details</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter exams title" class="form-control input-md" type="text">
